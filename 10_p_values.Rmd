...
The object we created, `patriots_sim`, is a data frame with a single column, called nflip.  Each entry represents the number of "H" outcomes (i.e. notional Patriots wins) in a single simulate of 25 coin flips:  
