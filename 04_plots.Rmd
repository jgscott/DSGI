...
Let's now make a jitter plot to show how the `disp` correlates with sales volume.  (This `disp` variable indicates whether the store had a marketing display for cheese that week.) 
